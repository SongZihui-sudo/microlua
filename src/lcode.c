...
static void savelineinfo( FuncState* fs, Proto* f, int line )
{
    ...
    luaM_growvector(
    fs->ls->L, f->lineinfo, pc, f->sizelineinfo, ls_byte, MAX_INT, "opcodes" );
...
int luaK_code( FuncState* fs, Instruction i )
{
    ...
    luaM_growvector(
    fs->ls->L, f->code, fs->pc, f->sizecode, Instruction, MAX_INT, "opcodes" );
    f->code[fs->pc++] = i;
...
*/
static void finishbinexpval(
FuncState* fs, expdesc* e1, expdesc* e2, OpCode op, int v2, int flip, int line, OpCode mmop, TMS event )
{
